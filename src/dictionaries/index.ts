  ...
  export type Dictionary = {
    ...
    "spoken-languages-likely-began-as-simple-sounds-tied-to-survival-over-time-these-sounds-grew-into-structured-speech-and-later-written-scripts-today-there-are-over-number-spoken-languages-across-the-world-each-with-its-own-story": string;
